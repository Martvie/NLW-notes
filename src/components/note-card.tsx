...
export const NoteCard = ({ date, content }: INoteCard) => {
    return (
        <Dialog.Root>
            <Dialog.Trigger
                className="rounded-md disolay flex flex-col bg-slate-800 p-5 gap-3 text-left overflow-hidden relative hover:ring-2
